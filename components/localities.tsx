...
export default function Localities() {
  return (
    <section className="py-8 sm:py-14 bg-white w-full" id="localities">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 max-w-[1200px] mx-auto">
          {localities.map(({ icon: Icon, label }) => (
            <motion.div
              key={label}
              className="border border-[#F3F4F6] rounded-[16px] sm:rounded-[20px] px-3 py-3 sm:px-6 sm:py-5 lg:px-8 flex items-center gap-3 sm:gap-4 text-[#4B5563] font-bold text-[13px] sm:text-[14px] cursor-default bg-white shadow-[0px_4px_20px_rgba(0,0,0,0.02)]"
              whileHover={{
                borderColor: '#FF2D3F',
                color: '#FF2D3F',
                y: -2,
